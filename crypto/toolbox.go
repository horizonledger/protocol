...
func VerifyMessageSign(signature btcec.Signature, pubkey btcec.PublicKey, message string) bool {
...
func VerifyMessageSignKeypair(signature btcec.Signature, keypair Keypair, message string) bool {
